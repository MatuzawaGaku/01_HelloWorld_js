...
var MyLayer = cc.Layer.extend({
    ctor: function() {
        ...
        */
        ...
        drop01.setPosition(size.width * 1 / 6, size.height / 1.25);　
        this.addChild(drop01);

        var drop02 = cc.Sprite.create(res.drop02_png);　
        drop02.setPosition(size.width * 2 / 6, size.height / 1.5);　
        this.addChild(drop02);

        var drop03 = cc.Sprite.create(res.drop03_png);　
        drop03.setPosition(size.width * 3 / 6, size.height / 2);　
        this.addChild(drop03);

        var drop04 = cc.Sprite.create(res.drop04_png);　
        drop04.setPosition(size.width * 4 / 6, size.height / 2.8);　
